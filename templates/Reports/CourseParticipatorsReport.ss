...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><% _t("CourseParticipatorsReport.TITLE","Course participators report") %></title>
	</head>
	...
	<body>
		...
		<div id="header">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="3" class="report-heading"><% _t("CourseParticipatorsReport.TITLE","Course participators report") %><br/></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
