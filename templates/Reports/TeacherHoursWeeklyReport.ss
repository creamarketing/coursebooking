...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><% _t("TeacherHoursWeeklyReport.TITLE","Week lessions report") %></title>
	</head>
	...
	<body>
		...
		<div id="header">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="3" class="report-heading"><% _t("TeacherHoursWeeklyReport.TITLE","Week lessions report") %><br/></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
		...
		<div class="page first">
			...
			<table cellpadding="0" cellspacing="0" class="dataTable">
				<thead>
					<th><% _t('TeacherHoursWeeklyReport.WEEK', 'Week') %></th>
				...
				<% control Sections %>
					...
					<tr>
						<td>&nbsp;</td>
						<td class="bold"><% _t('TeacherHoursWeeklyReport.ALLHOURS', 'Week hours total') %></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
