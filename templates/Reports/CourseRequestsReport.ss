...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><% _t("CourseRequestsReport.TITLE","Course requests report") %></title>
	</head>
	...
	<body>
		...
		<div id="header">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="3" class="report-heading"><% _t("CourseRequestsReport.TITLE","Course requests report") %><br/></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
		...
		<div class="page first">
			...
			<table cellpadding="0" cellspacing="0" class="dataTable">
				...
				<% control Course.CourseRequests %>
					<tr>
						<td>$Participator.Surname</td>
						<td>$Participator.FirstName</td>
