...
class CourseMainClass extends DataObject {
	...
	function getCMSFields($includeDOMS = true) {
		...
		$mainTab->push(new TextField('Code', _t('CourseMainClass.CODE', 'Code')));
		$mainTab->push(new TextField('Name', _t('CourseMainClass.DESC', 'Name')));
	...
	static function toDropdownList() {
		$objects = DataObject::get('CourseMainClass', '', 'Code ASC');
		$list = array('' => '');
