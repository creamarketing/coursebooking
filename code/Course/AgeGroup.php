...
class AgeGroup extends DataObject {
	...
	function getCMSFields($includeDOMS = true) {
		...
		$mainTab->push(new TextField('Code', _t('AgeGroup.CODE', 'Code')));
		$mainTab->push(new TextField('Name', _t('AgeGroup.DESC', 'Name')));
	...
	static function toDropdownList() {
		$objects = DataObject::get('AgeGroup', '', 'Code ASC');
		$list = array('' => '');
